...
public final class Timber {
  ...
  /**
   * An indirection for providing Android-style log levels.
   */
  public static final class Level {
    public static final int VERBOSE = 600;
    public static final int DEBUG = 700;
    public static final int INFO = 800;
    public static final int WARN = 900;
    public static final int ERROR = 1000;
    public static final int ASSERT = 1100;
  }
  ...
  public static abstract class Tree {
     ...
     *
     * @param priority Log level. See {@link Level} for constants.
